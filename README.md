...
Learns Quantum Signal Processing (QSP) phase angles from random initialization using JAX automatic differentiation and Optax's Adam optimizer — recovering polynomial transformations on a PennyLane quantum circuit without requiring an analytic angle solver.
